...
public class Sabana {
	...
	public Sabana(int clave_horario, String clave_maestro, String clave_materia, String clave_carrera, String materia,
			String carrera, String maestro, String periodo, String turno, String grupo, int no_alumnos, int semestre,
			int creditos, String lunes, String martes, String miercoles, String jueves, String viernes, String salon,
			int horas_t, int horas_p) {
		super();

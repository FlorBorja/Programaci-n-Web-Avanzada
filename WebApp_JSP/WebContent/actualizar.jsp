...
<%
	...
	if(session.getAttribute("rol").equals(1)){
		Materia materia = new Materia(Integer.parseInt(request.getParameter("id")), request.getParameter("clave"), 
				request.getParameter("nombre"), Integer.parseInt(request.getParameter("semestre")), request.getParameter("carrera"), 
